        ...
        <div className="flex flex-col md:flex-row justify-center items-start md:space-x-12">
          ...
          <div className="md:w-1/3 mb-8 md:mb-0">
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
              <div className="mb-4">
                <img src={servicio1Img} alt="Automatización Inteligente de Procesos" className="mx-auto h-16 rounded-lg" />
              </div>
          ...
          <div className="md:w-1/3 mb-8 md:mb-0">
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
              <div className="mb-4">
                <img src={servicio2Img} alt="Centralización y Gestión de Datos" className="mx-auto h-16 rounded-lg" />
              </div>
          ...
          <div className="md:w-1/3">
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
              <div className="mb-4">
                <img src={servicio3Img} alt="Análisis Avanzado y Business Intelligence" className="mx-auto h-16 rounded-lg" />
              </div>
